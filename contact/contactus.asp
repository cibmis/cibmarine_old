    ...
    <td colspan="3">
      <table width="810" border="0" cellspacing="0" cellpadding="0" height="24">
        <tr> 
          ...
          <td class="cibBreadcrumb" width="609"><a href="../index.asp"> Home</a> &gt; <a href="contactus.asp">Contact Us</a></td>
        </tr>
      </table>
    </td>
  </tr>
      ...
      <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="786">
        <tr> 
                    ...
                    <td bgcolor="#A3A3A3" valign="top"><img src="../art/life_at_CIB.gif" alt="Life At CIB Marine" width="145" height="9" /><br />
                        ...
                        <table class="white_nav" width="169" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            ...
                            <td width="146"><a href="../corp_info/shareholders.asp">Investor Relations</a></td>
                          </tr>
                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146"><a href="../corp_info/banking_subs.asp">Banking Subsidiaries</a></td>
                          </tr>
                          <!--                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
          ...
          <td valign="top" width="585"> 
            ...
            <img src="../images/heads/contactus.gif" alt="Contact Us" width="608" height="26" /> 
...
<br />
  ...
  <tr>
    ...
    <td width="98%" class="grey_text"><br />    <br /></td>
    <td width="1%"></td>
  </tr>
</table>
