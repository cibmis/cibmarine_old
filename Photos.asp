...
.style6 {font-family: Geneva, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 18px; }
.style8 {font-size: 15px; color: #000066; }
.style10 {font-size: 13px; font-weight: bold; color: #000066; }
...
<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
   <td colspan="3">    <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="786">
     <tr>
       ...
       <td valign="top" width="585"><table width="608" border="0" cellspacing="0" cellpadding="0">
           <tr>
           ...
           <p class="style6">Photos Featured in Press Releases </p>
           <table width="560" border="1">
             <tr valign="top" class="cibbold">
               <td width="150"><span class="style8">Date of Release </span></td>
               <td width="283"><span class="style8">Title of Release </span></td>
               <td width="105"><span class="style8">Photo</span></td>
             </tr>
             <tr valign="top">
               <td class="cibbold"><span class="style10">October 12, 2006</span></td>
               <td class="cibbold"><span class="style10">Marine Bank Promotes Darci Miller to Senior Vice President </span></td>
               <td><img src="images/46956-037DarciMiller.jpg" width="200" height="286" /></td>
             </tr>
             <tr valign="top">
