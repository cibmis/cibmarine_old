    ...
    <td colspan="2">
      <table width="810" border="0" cellspacing="0" cellpadding="0" height="24">
        <tr> 
          ...
          <td class="cibBreadcrumb" width="609"><a href="../index.asp">Home</a> &gt; <a href="banking_subs.asp">Banking
            Subsidiaries</a></td>
        </tr>
      </table>
    </td>
            ...
            <table bgcolor="#A3A3A3" border="0" cellpadding="0" cellspacing="0" width="76">
              <tr> 
                <td bgcolor="#A3A3A3" valign="top">
                  <table width="234" border="0" cellspacing="0" cellpadding="10" height="145">
                    <tr>
                      <td width="214" valign="top" bgcolor="#A3A3A3"><img src="../art/life_at_CIB.gif" alt="Life At CIB Marine" width="145" height="9" /><br />
                          ...
                          <table class="white_nav" width="169" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                              ...
                              <td width="146"><a href="shareholders.asp">Investor Relations</a></td>
                            </tr>
                            <tr>
                              <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td width="146"><a href="banking_subs.asp">Banking Subsidiaries</a></td>
                            </tr>
                            <!--                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146"><a href="corp_info/nonbanking_subs.asp">
							Non-Banking Subsidiaries/a></td>
                          </tr>-->
                            <tr>
                              <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td><a href="careers.asp">Careers</a></td>
                            </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td bgcolor="#A3A3A3" valign="top"><img src="../art/career_ops.gif" alt="Career Opportunities" width="145" height="9" /><br />
                          ...
                          <table class="white_nav" width="204" border="0" cellspacing="0" cellpadding="4">
                            <tr>
                              <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td width="215"><a href="../financial_info/press_releases.asp">Press Releases</a></td>
                            </tr>
                            <tr>
                              <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td width="215"><a href="AdditionalFinancialInformation.asp">Additional Financial Info</a></td>
                            </tr>
                            <tr>
                              <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            ...
                            <tr>
                              <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td><a href="../financial_info/sec_filings.asp">SEC Filings</a></td>
                            </tr>
                            <tr>
                              <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
          ...
          <td valign="top" width="585"> 
            <table width="608" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <p class="style38" style="margin-top: 0; margin-bottom: 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Banking Subsidiaries</p></td>
                <td bgcolor="#292929" width="216">&nbsp;</td>
              </tr>
            </table>
            <table width="599" border="0" cellspacing="0" cellpadding="15" height="22">
              <tr> 
                <td valign="top" height="51" width="569">                  
				<table class="cib" width="448"  cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #323264">
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td colspan="2" bgcolor="#323264" class="cibChartHeadBig" >CIBM Bank </td>
                    </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td width="115" rowspan="2" ><span class="style43"></span></td>
                    <td><span class="style43"><strong>Main Office:</strong></span></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td height="74"><p class="style43" style="margin-top: 0;">2913 W. Kirby Avenue<br />
Champaign, IL&nbsp; 61821<br />
Phone: (217) 355-0900 </p>
                      <p class="style43" style="margin-bottom: 0;"><a href="http://www.cibmbank.com">www.cibmbank.com</a>                      </p></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                  ...
                  <tr valign="top">
                    <td height="6" colspan="2"><hr size="1" noshade="noshade" /></td>
                  </tr>
                  <tr valign="top">
                    <td height="60" ><span class="style43"></span></td>
                    <td><p class="style43" style="margin-top: 0;"><strong>Illinois Market Headquarters: </strong><br />
2913 W. Kirby Avenue<br />
Champaign, IL&nbsp; 61821<br />
Phone: (217) 355-0900</p>                      </td>
                  </tr>
                  <tr valign="top">
                    <td height="6" colspan="2"><hr size="1" noshade="noshade" /></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td height="73" ><span class="style43"></span></td>
                    <td width="323"><p class="style43" style="margin-top: 0; margin-bottom: 0;"><strong>Indiana Market Headquarters: </strong><br />
                      5120 E. 82nd Street<br />
Indianapolis, IN<span class="style43" style="margin-top: 0;">&nbsp; </span>46250 <br />
  Phone: (317) 542-5700</p>
                      </td>
                  </tr>
                </table>				
  				<table class="cib" style="border:1px solid #323264" width="448" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
                  <tr valign="top" bgcolor="#323264">
                    <td width="528" class="cibChartHeadBig">&nbsp;</td>
                    </tr>
                </table></td>
              </tr>
            </table>
  ...
  <tr>
    <td colspan="2" align="right" bgcolor="#000000"><img src="../art/img_footer.gif" alt="Copyright 2003 CIB Marine Bancshares, Inc." name="img_footer" width="350" height="23" border="0" id="img_footer" /></td>
  </tr>
  <tr>
    <td width="20%" class="cib"><div align="center"><img src="../art/icons_member_assoc.gif" alt="Member FDIC and Equal Housing Lender logos" width="83" height="26" /></div></td>
    <td class="cib"><p>&nbsp;</p>
    </td>
  </tr>
  <tr>
