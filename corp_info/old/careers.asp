      ...
      <table width="810" border="0" cellspacing="0" cellpadding="0" height="24">
        <tr> 
          ...
          <td width="609"><a href="../index.asp"><font class="cib">Home</font></a><font class="white_text"> 
            <span class="cib">&gt; </span></font><span class="cib"></span><a href="careers.asp"><font class="cib">Careers</font></a></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table width="201" border="0" cellspacing="0" cellpadding="10" height="145">
                      ...
                      <td bgcolor="#A3A3A3" valign="top"><img src="../art/life_at_CIB.gif" alt="Life At CIB Marine" width="145" height="9" /><br />
                        ...
                        <table width="169" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            ...
                            <td width="146" nowrap="nowrap"><a href="shareholders.asp"><span class="white_text">Investor
                                  Relations</span></a></td>
                          </tr>
                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146" nowrap="nowrap"><a href="banking_subs.asp"><span class="white_text">Banking
                                  Subsidiaries </span></a></td>
                          </tr><!--                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146" nowrap="nowrap"><a href="nonbanking_subs.asp"><span class="white_text">Non-Banking
                                  Subsidiaries </span></a></td>
                          </tr>-->
                          <tr>
                            <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td nowrap="nowrap"><a href="careers.asp"><span class="white_text">Careers</span></a></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#A3A3A3" valign="top"><img src="../art/career_ops.gif" alt="Career Opportunities" width="145" height="9" /><br />
                        ...
                        <table width="169" border="0" cellspacing="0" cellpadding="4">
                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146" nowrap="nowrap"><a href="../financial_info/sec_filings.asp"><span class="white_text">SEC
                                  Filings </span></a></td>
                          </tr>
                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146" nowrap="nowrap"><p><a href="../financial_info/section16.asp"><span class="white_text">Insider Filings</span></a></p></td>
                          </tr>
                          <tr>
                            <td width="4"><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td width="146" nowrap="nowrap"><a href="../financial_info/press_releases.asp"><span class="white_text">Press
                                  Releases </span></a></td>
                          </tr>
                          <tr>
                            <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                            <td nowrap="nowrap"><a href="../financial_info/holderletters.asp"><span class="white_text">Shareholder
                                  Letters</span></a></td>
                          </tr>
                        </table></td>
                    </tr>
          ...
          <td valign="top" width="585"> 
            ...
            <img src="../images/heads/cibm_benefits.gif" alt="Employee Benefit Programs" width="608" height="26" /> 
            <table width="599" border="0" cellspacing="0" cellpadding="15" height="22">
              <tr> 
                <td valign="top" class="cib" height="51" width="569"> 
                  <p>CIB Marine Bancshares, Inc.&nbsp; (CIBM) has great opportunities
                    ...
                    and more freedom to manage their own careers and make their
                  own success. </p>
