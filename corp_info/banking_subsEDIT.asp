        ...
        <tr> 
                    ...
                    <tr>
                      <td bgcolor="#A3A3A3" valign="top"><img src="../art/life_at_CIB.gif" alt="Life At CIB Marine" width="145" height="9" /><br />
                          ...
                          <table class="white_nav" width="169" border="0" cellspacing="0" cellpadding="4">
                            ...
                            <tr>
                              <td><img src="../art/icon_wht_bullet.gif" width="4" height="4" /></td>
                              <td><a href="CorporateGovernance.asp" target="_blank">Corporate Governance </a></td>
                            </tr>
                        </table></td>
                    </tr>
                    <tr>
          ...
          <td valign="top" width="585"> 
            <table width="608" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td bgcolor="#292929" width="392"><img src="../images/heads/corp_info.gif" alt="Life At CIB Marine Bancshares, Inc." width="305" height="43" /></td>
                <td bgcolor="#292929" width="216">&nbsp;</td>
              </tr>
            </table>
            <img src="../images/heads/cibm_life_enrichment.gif" alt="Life Enrichment Programs" width="608" height="26" /> 
            <table width="599" border="0" cellspacing="0" cellpadding="15" height="22">
              <tr> 
				...
				<table class="cib" width="448"  cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #323264">
                  ...
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td rowspan="2" >&nbsp;</td>
                    <td><strong>Main Office</strong><strong>:</strong></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td><p style="margin-top: 0;">2913 W. Kirby Avenue<br />
Champaign, IL&nbsp; 61821<br />
Phone: (217) 355-0900 </p>
                      <p style="margin-bottom: 0;"><a href="http://www.cibmbank.com">www.cibmbank.com</a> 
                      </p></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                  ...
                  <tr valign="top">
                    <td >&nbsp;</td>
                    <td><p style="margin-top: 0;"><strong>Wisconsin market headquarters: </strong><br />
                      N27 W24025 Paul Court<br />
                      Pewaukee, WI  53072<br />
                      Phone: (262) 695-6000</p>
                      <p><strong>John P. Hickey, Jr. <br />
                        <span class="grey_text"> President &amp; CEO <br />
                        </span></strong><strong><span class="grey_text">Wisconsin Market President</span></strong></p></td>
                  </tr>
                  <tr valign="top">
                    <td height="19" colspan="2"><hr size="1" noshade="noshade" /></td>
                  </tr>
                  <tr valign="top">
                    <td >&nbsp;</td>
                    <td><p style="margin-top: 0;"><strong>Illinois market headquarters: </strong><br />
...
Phone:&nbsp; (217) 355-0900 </p></td>
                  ...
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td >&nbsp;</td>
                    <td width="323"><p style="margin-top: 0;"><strong>Indiana market headquarters: </strong><br />
  5435 N. Emerson Way<br />
  Indianapolis, IN&nbsp; 46226<br />
  Phone: (317) 542-5700</p>
                      <p><strong>J. Brian Chaffin<br />
                          <span class="grey_text">Illinois &amp; Indiana Market President<br />
                          </span></strong></p></td>
                  </tr>
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td height="19" colspan="2"><hr size="1" noshade="noshade" /></td>
                  ...
                  <tr valign="top" bgcolor="#FFFFFF">
                    <td width="115" height="98"><p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
<p>&nbsp;</p>
<p style="margin-bottom: 0;">&nbsp;</p>
</td>
                    <td><p style="margin-top: 0;"><strong>Western market headquarters:<br />
                      </strong>15030 N. Hayden Rd., Suite C120<br />
                      Scottsdale, AZ&nbsp; 85260 <br />
                      Phone: (480) 368-2600 </p>
                      <p style="margin-top: 0; margin-bottom: 0"><strong>Robert P. Churan</strong></p>
                      <p class="grey_text" style="margin-top: 0;"><strong>Arizona Market President</strong><br />
                        <br />
                      </p></td>
                  </tr>
                </table>				
